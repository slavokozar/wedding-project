        ...
        <div class="flex flex-1 flex-col justify-center px-4 py-12 sm:px-6 lg:flex-none lg:px-20 xl:px-24">
            <div class="mx-auto w-full max-w-sm lg:w-96">
                <div>
                    ...
                    <h2 class="mt-8 text-2xl font-bold tracking-tight text-gray-900 notoserifdisplay font-thin">Potvrdiť účasť na svadbe</h2>
                    <p class="mt-2 text-sm text-gray-500">
                        Dostali ste od nás pozvánku na svatbu?
                    </p>
                    ...
                    <p class="mt-2 text-sm text-gray-500">
                    Aby sme mohli všetko dokonale naplánovať vyplňte nám prosím krátky dotazník.
                    </p>
                    <p class="mt-2 text-sm text-gray-500">

                    Začnite prosím zadaním kódu z Vašej pozvánky.
                    </p>
                </div>
                ...
                <div class="mt-10">
                    <div>
                        <form action="{{ route('invitation-submit') }}" method="POST" class="space-y-6">
                            @csrf
                            {!! RecaptchaV3::field('invitation') !!}
                            <div>
                                <label for="code" class="hidden block text-sm/6 font-medium text-gray-900">
                                    kód z pozvánky
                                </label>
                                <div class="mt-2">
                                    <input
                                        ...
                                        required
                                        autoComplete="off"
                                        placeholder="kód z pozvánky"
                                        class="block w-full bg-white px-3 py-1.5 text-base text-gray-900 outline-1 -outline-offset-1 outline-gray-300 placeholder:text-gray-400 focus:outline-2 focus:-outline-offset-2 focus:outline-gray-600 sm:text-sm/6"
                                    />
                                </div>
                            </div>
                            ...
                            <div>
                                <button
                                    type="submit"
                                    class="flex w-full justify-center bg-gray-600 px-3 py-1.5 text-sm/6 font-semibold text-white shadow-xs hover:bg-gray-500 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-gray-600"
                                >
                                    Sign in
                                </button>
                            </div>
